...
class GraphGANOptimizer(object):
    ...
    def __init__(self, model, learning_rate=1e-3, feature_matching=True):
        ...
        with tf.name_scope('losses'):
            ...
            variable_summaries(grad0)
            variable_summaries(grad1)
        ...
        variable_summaries(self.loss_D)
        variable_summaries(self.loss_G)
        variable_summaries(alpha)
        variable_summaries(self.grad_penalty)
        variable_summaries(self.la)
